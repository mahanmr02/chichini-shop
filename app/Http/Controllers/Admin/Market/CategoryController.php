...
class CategoryController extends Controller
{
    ...
    public function store(ProductCategoryRequest $request,ImageService $imageService)
    {
        ...
        $inputs['slug'] = slugFa($inputs['name']);
        $inputs['image'] = $result;
    ...
    public function update(ProductCategoryRequest $request, ProductCategory $productCategory,ImageService $imageService)
    {
        ...
        return redirect()->route('admin.market.category.index')->with('swal-success', 'دسته بندی شما با موفقیت ویرایش گردید');
    }
    ...
    public function destroy(ProductCategory $productCategory)
    {
       ...
       return redirect()->route('admin.market.category.index')->with('swal-success', 'دسته بندی شما با موفقیت حذف گردید');
    }
}
