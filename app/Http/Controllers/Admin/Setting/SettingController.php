...
class SettingController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Setting $setting, SettingRequest $request,ImageService $imageService)
    {
        $inputs = $request->all();
        ...
        return redirect()->route('admin.setting.index')->with('swal-success', 'تنظیمات شما با موفقیت ویرایش گردید');
