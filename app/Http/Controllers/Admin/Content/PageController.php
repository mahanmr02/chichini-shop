...
class PageController extends Controller
{
    ...
    public function store(PageRequest $request)
    {
        ...
        return redirect()->route('admin.content.page.index')->with('swal-success', 'پیج جدید شما با موفقیت ثبت شد');
    }
    ...
    public function update(PageRequest $request, Page $page)
    {
        ...
        $page->update($inputs);
        return redirect()->route('admin.content.page.index')->with('swal-success', 'پیج شما با موفقیت ویرایش گردید');
    }
    ...
    {
       $result = $page->delete();
       return redirect()->route('admin.content.page.index')->with('swal-success', 'پیج شما با موفقیت حذف گردید');
    }
