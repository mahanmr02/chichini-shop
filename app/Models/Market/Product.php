...
class Product extends Model
{
    ...
    protected $fillable = ['name','introduction','slug','status','image','tags','weight','length','width','height','price','marketable','sold_number','forzen_number','marketable_number','brand_id','category_id','published_at'];
