...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        //color
            ...
            Route::get('/color/{product}/create', [ProductColorController::class, 'create'])->name('admin.market.product.color.create');
        ...
        //gallery
            ...
            Route::get('/gallery/create/{product}', [GalleryController::class, 'create'])->name('admin.market.product.gallery.create');
            Route::post('/gallery/store/{product}', [GalleryController::class, 'store'])->name('admin.market.product.gallery.store');
            Route::delete('/gallery/destroy/{product}/{gallery}', [GalleryController::class, 'destroy'])->name('admin.market.product.gallery.destroy');
        ...
        Route::prefix('property')->group(function () {
            ...
            //value
            Route::get('/value/{categoryAttribute}', [CategoryValueController::class, 'index'])->name('admin.market.property.value.index');
            Route::get('/value/{categoryAttribute}/create', [CategoryValueController::class, 'create'])->name('admin.market.property.value.create');
            Route::post('/value/{categoryAttribute}/store', [CategoryValueController::class, 'store'])->name('admin.market.property.value.store');
            Route::get('/value/edit/{categoryAttribute}/{categoryValue}', [CategoryValueController::class, 'edit'])->name('admin.market.property.value.edit');
            Route::put('/value/update/{categoryAttribute}/{categoryValue}', [CategoryValueController::class, 'update'])->name('admin.market.property.value.update');
            Route::delete('/value/destroy/{categoryAttribute}/{categoryValue}', [CategoryValueController::class, 'destroy'])->name('admin.market.property.value.destroy');            
        });
        //store
    ...
    Route::prefix('content')->namespace('Content')->group(function () {
        ...
        Route::prefix('comment')->group(function () {
            ...
            // Route::get('/create', [ContentCommentController::class, 'index'])->name('admin.content.comment.create');
    ...
    Route::prefix('user')->namespace('User')->group(function () {
        ...
        Route::prefix('customer')->group(function () {
            Route::get('/', [CustomerController::class, 'index'])->name('admin.user.customer-user.index');
            Route::get('/create', [CustomerController::class, 'create'])->name('admin.user.customer-user.create');
            Route::post('/store', [CustomerController::class, 'store'])->name('admin.user.customer-user.store');
            Route::get('/edit/{customer}', [CustomerController::class, 'edit'])->name('admin.user.customer-user.edit');
            Route::put('/update/{customer}', [CustomerController::class, 'update'])->name('admin.user.customer-user.update');
            Route::delete('/destroy/{customer}', [CustomerController::class, 'destroy'])->name('admin.user.customer-user.destroy');
            Route::get('/activation/{customerUser}', [CustomerController::class, 'activation'])->name('admin.user.customer-user.activation');
            Route::get('/status/{customerUser}', [CustomerController::class, 'status'])->name('admin.user.customer-user.status');
        });
        ...
        Route::prefix('role')->group(function () {
            ...
            Route::put('/permission-form-update/{role}', [RoleController::class, 'permissionFormUpdate'])->name('admin.user.role.permission-form-update');
        });
        ...
        Route::prefix('permission')->group(function () {
            ...
            Route::get('/edit/{role}', [PermissionController::class, 'edit'])->name('admin.user.permission.edit');
